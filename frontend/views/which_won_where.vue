<template>
  <div style="display: flex; justify-content: space-between; margin-top: 10px">
    <!-- which_won_where图 -->
    <div class="which_won_where">
      <div class="title">WorkPlace</div>
      <div class="name" v-if="src == null">which won where</div>
      ...
      <div class="form">
        ...
        <el-form ref="form" :model="form" label-width="80px">
          ...
          <el-row :gutter="20">
            ...
            <el-col :span="12"
              ><div class="grid-content bg-purple">
                <el-form-item label="encircle line color" label-width="10vw">
                  <el-color-picker
                    v-model="form.encircle_line_color"
                  ></el-color-picker>
                </el-form-item></div
            ></el-col>
          </el-row>
          ...
          <el-row :gutter="20">
            ...
            <el-col :span="12"
              ><div class="grid-content bg-purple">
                <el-form-item label="encircle line size" label-width="10vw">
                  <el-select
                    v-model="form.encircle_line_size"
                    placeholder="select size"
                  >
                    <el-option
                      v-for="item in line_size_list"
...
export default {
  ...
  methods: {
    ...
    uploadVideo(fileObj) {
      ...
      this.$axios
        .post(
          "http://127.0.0.1:8000/api/upload_for_which_won_where/",
          formData,
          {
            headers: {
    ...
    onSubmit() {
      this.$axios({
        method: "post",
        url: "http://127.0.0.1:8000/api/draw_which_won_where/",
        data: { file: this.form },
      }).then((res) => {
...
@import "../src/assets/less/which_won_where.less";
</style>