...
export default {
  ...
  methods: {
    tz() {
      this.$router.push({ path: "/heat_qsy" });
    },
  ...
  mounted() {
    this.$axios({
      method: "get",
      url: "http://127.0.0.1:8000/api/heat_yzy/",
    }).then((res) => {
      ...
      series: [
        {
          ...
          //   stack: "Total",
          data: [
            5.0, 7.0, 9.0, 11.0, 12.5, 14.5, 16.0, 17.0, 18.5, 19.5, 20.5, 21.5,
            22.0,
          ],
          tooltip: {
            show: false,
            ...
            formatter: function (params) {
              ...
              var str =
                res +
                `<div style = "background:url( ${require("@/assets/images/银中杨.jpg")}) no-repeat center center ;width:90%;height:90%;padding:22px 20px;font-size: 16px; background-size: contain;"></div>`;
              return str;
            },
          },
        },
        {
          ...
          //   stack: "Total",
          data: [
            4.5, 6.5, 8.5, 10.5, 12, 13.5, 15, 16.5, 17.5, 19, 19.5, 20.5, 21,
          ],
          tooltip: {
            show: false,
            trigger: "item",
        ...
        },
        {
          ...
          symbolSize: 20, //设定实心点的大小
          //   stack: "Total",//数据堆叠
          data: [4, 6, 8, 10, 11.5, 13.5, 15, 16, 17.5, 18.5, 19.5, 20, 20.5],
          tooltip: {
            show: false,
            trigger: "item",
            extraCssText: "max-width:40%;white-space:pre-wrap",
