<template>
  <div style="display: flex; justify-content: space-between; margin-top: 10px">
    ...
    <div class="ammi">
      ...
      <div class="name" v-if="src == null">AMMI</div>
      ...
      <div class="form">
        ...
        <el-form ref="form" :model="form" label-width="80px">
          ...
          <el-row :gutter="20">
            ...
            <el-col :span="12"
              ><div class="grid-content bg-purple">
                <el-form-item label="line color" label-width="10vw">
                  <el-color-picker v-model="form.line_color"></el-color-picker>
                </el-form-item></div
            ></el-col>
          </el-row>
          <!-- 第二行 -->
          ...
          <el-row :gutter="20">
            ...
            <el-col :span="12"
              ><div class="grid-content bg-purple">
                <el-form-item label="line size" label-width="10vw">
                  <el-select v-model="form.line_size" placeholder="select size">
                    <el-option
...
export default {
  data() {
    return {
      ...
      form: {
        ...
        place_text_size: 10,
        place_text_color: "#38DE0E", //green

        line_color: "#F20909", //红色
        line_size: 1,

        clone_scatter_size: 30,
        clone_scatter_color: "#F46207", //橙色
  ...
  mounted() {
    // this.query.key是示范数据里面勾选框页面传过来的数据
  ...
  methods: {
    ...
    uploadVideo(fileObj) {
      ...
      this.$axios
        .post("http://127.0.0.1:8000/api/upload_for_ammi/", formData, {
          headers: {
    ...
    onSubmit() {
      this.$axios({
        method: "post",
        url: "http://127.0.0.1:8000/api/draw_ammi/",
        data: { file: this.form },
      }).then((res) => {
...
@import "../src/assets/less/ammi.less";
</style>